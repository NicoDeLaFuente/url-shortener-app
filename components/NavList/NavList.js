...
const NavList = () => {
    return  <nav id="nav" className=" p-5 py-8 bg-darkViolet rounded-md text-white hidden absolute top-20 right-8 w-10/12 flex flex-col items-center gap-6 sm:bg-transparent sm:text-grayViolet sm:static sm:flex sm:flex-row sm:justify-between sm:grow">
