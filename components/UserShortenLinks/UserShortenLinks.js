...
export default function UserShortenLinks (){
    ...
    return  <div className="hidden p-4 flex flex-col bg-white w-4/5 rounded-md items-center justify-center gap-2 sm:max-w-5xl sm:flex-row sm:justify-between sm:px-6">
                <LinkEnteredByUser/>
